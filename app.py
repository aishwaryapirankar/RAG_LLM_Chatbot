...
def speak_answer(answer):
    ...
    tts.save("answer.mp3") # Save the audio to a temporary file

    st.audio("answer.mp3", autoplay=True)  # Autoplay the speech answer in Streamlit
    os.remove("answer.mp3")  # Remove temporary audio file
